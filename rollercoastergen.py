...
class RCG_OT_addtrack10(Operator):
    ...
    def execute(self, context):
        bpy.ops.wm.append(
            filepath=os.path.join(file_track10, inner_track10, object_track10),
            directory=os.path.join(file_track10, inner_track10),
            filename=object_track10
        )
...
class RCG_OT_addtrack20(Operator):
    ...
    def execute(self, context):
        bpy.ops.wm.append(
            filepath=os.path.join(file_track20, inner_track20, object_track20),
            directory=os.path.join(file_track20, inner_track20),
            filename=object_track20
        )
...
class RCG_OT_addinvtrack05(Operator):
    ...
    def execute(self, context):
        bpy.ops.wm.append(
            filepath=os.path.join(file_invtrack05, inner_invtrack05, object_invtrack05),
            directory=os.path.join(file_invtrack05, inner_invtrack05),
            filename=object_invtrack05
        )
...
class RCG_OT_addinvtrack10(Operator):
    ...
    def execute(self, context):
        bpy.ops.wm.append(
            filepath=os.path.join(file_invtrack10, inner_invtrack10, object_invtrack10),
            directory=os.path.join(file_invtrack10, inner_invtrack10),
            filename=object_invtrack10
        )
...
class RCG_OT_addinvtrack20(Operator):
    ...
    def execute(self, context):
        bpy.ops.wm.append(
            filepath=os.path.join(file_invtrack20, inner_invtrack20, object_invtrack20),
            directory=os.path.join(file_invtrack20, inner_invtrack20),
            filename=object_invtrack20
        )
...
class RCG_OT_addngtrack1(Operator):
    ...
    def execute(self, context):
        bpy.ops.wm.append(
            filepath=os.path.join(file_ngtrack1, inner_ngtrack1, object_ngtrack1),
            directory=os.path.join(file_ngtrack1, inner_ngtrack1),
            filename=object_ngtrack1
        )
...
class RCG_OT_addruler05(Operator):
    ...
    def execute(self, context):
        bpy.ops.wm.append(
            filepath=os.path.join(file_trackruler05, inner_trackruler05, object_trackruler05),
            directory=os.path.join(file_trackruler05, inner_trackruler05),
            filename=object_trackruler05
        )
...
class RCG_OT_addruler10(Operator):
    ...
    def execute(self, context):
        bpy.ops.wm.append(
            filepath=os.path.join(file_trackruler10, inner_trackruler10, object_trackruler10),
            directory=os.path.join(file_trackruler10, inner_trackruler10),
            filename=object_trackruler10
        )
...
class RCG_OT_addruler20(Operator):
    ...
    def execute(self, context):
        bpy.ops.wm.append(
            filepath=os.path.join(file_trackruler20, inner_trackruler20, object_trackruler20),
            directory=os.path.join(file_trackruler20, inner_trackruler20),
            filename=object_trackruler20
        )
...
class RCG_OT_addflatruler05(Operator):
    ...
    def execute(self, context):
        bpy.ops.wm.append(
            filepath=os.path.join(file_trackflatruler05, inner_trackflatruler05, object_trackflatruler05),
...
class RCG_OT_addflatruler10(Operator):
    ...
    def execute(self, context):
        bpy.ops.wm.append(
            filepath=os.path.join(file_trackflatruler10, inner_trackflatruler10, object_trackflatruler10),
...
class RCG_OT_addflatruler20(Operator):
    ...
    def execute(self, context):
        bpy.ops.wm.append(
            filepath=os.path.join(file_trackflatruler20, inner_trackflatruler20, object_trackflatruler20),
...
classes = [
    ...
    RCG_OT_addtrack10,
    RCG_OT_addtrack20,
    RCG_OT_addinvtrack05,
    RCG_OT_addinvtrack10,
    RCG_OT_addinvtrack20,
    RCG_OT_addngtrack1,
    RCG_OT_addflatruler05,
    RCG_OT_addflatruler10,
    RCG_OT_addflatruler20,
    RCG_OT_addruler05,
    RCG_OT_addruler10,
    RCG_OT_addruler20,
    RCG_OT_addarray,
    ...
    RCG_OT_Exp_Banked_path_abs,
    RCG_OT_Exp_Flat_path,
    RCG_OT_Exp_Flat_path_abs,
    RCG_PT_sidebar,
    SelectFileEmpties,
    SelectFileNurbs,
]
